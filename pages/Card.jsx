...
export const CardItem = (props) => {
   ...
   const countMinus = () => {
      props.count > 1 ? props.setCount(props.count - 1) : props.setCount(props.count);
      ...
      <div className={styles.flexelem}>
         <div className={styles.leftside}>
            ...
            <div className={styles.cartInfo}>
               ...
               <div className={styles.btn}>
                  <button>в избранное</button><button>удалить</button>
               </div>
            </div>
         </div>
         <div className={styles.price}>
            <div>
               ...
               <div className={styles.num}>{props.newprice}</div>
            </div>
...
const Card = ({ product, CartInfo, count, setCount }) => {
      ...
      <div className={styles.container}>
         <div>
            ...
            <div className={styles.total}>
               ...
               <div className={styles.totalPrice}>90.00</div>
               <div className={styles.amount}>Товары, 2 шт.</div>
            </div>
         </div>
         <div>
